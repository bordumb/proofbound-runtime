...
draft platform vocabulary, identity roles, composition rules, and integration
...
| --- | --- | --- |
| RT-7 | [Distribution and integration](rt-07-compatibility-and-distribution.md) | Independent package identities and tested combinations |
