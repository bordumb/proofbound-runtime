...
pub use trace::{
    ...
    LauncherPause, PreparedTraceCommand, SpawnedTrace, TraceCaptureLimits, TraceCapturedOperands,
    TraceDeadline, TraceDrainObservation, TraceDrainReport, TraceObservationError,
