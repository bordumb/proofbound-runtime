...
package-label = (text .size (5..64)) .regexp "[0-9]+\\.[0-9]+\\.[0-9]+(-[0-9A-Za-z.-]+)?(\\+[0-9A-Za-z.-]+)?"

verifier-package-artifact = {
  "name": (text .size (37..96)) .regexp "proofbound-runtime-verify-[0-9]+\\.[0-9]+\\.[0-9]+(-[0-9A-Za-z.-]+)?(\\+[0-9A-Za-z.-]+)?\\.crate",
