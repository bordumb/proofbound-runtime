...
class ReleaseWorkflowTests(unittest.TestCase):
    ...
    def test_registry_publication_is_explicit_protected_and_ordered(self) -> None:
        workflow = WORKFLOW.read_text(encoding="utf-8")
        ...
        typescript_sdk = workflow.index("\n  publish-typescript-sdk:\n")
        observe = workflow.index("\n  observe-registry-packages:\n")
        self.assertLess(verifier, rust_sdk)
        self.assertLess(rust_sdk, python_sdk)
        self.assertLess(python_sdk, typescript_sdk)
        self.assertLess(typescript_sdk, observe)
