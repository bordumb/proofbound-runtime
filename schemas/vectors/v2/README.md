...
boundary and release state, and cleanup result. A failure before launcher
start has no install-request identity or retained launcher frame. Later
failures bind only the launcher prefix that existed. Trusted-computing-base
